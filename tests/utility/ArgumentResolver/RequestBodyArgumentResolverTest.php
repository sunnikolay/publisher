...
namespace App\Tests\utility\ArgumentResolver;

use App\Entity\Book;
use App\Exception\RequestBodyConvertException;
use App\Exception\ValidationException;
use App\utility\ArgumentResolver\RequestBodyArgumentResolver;
...
class RequestBodyArgumentResolverTest extends TestCase
{
    ...
    public function testSupports(): void
    {
        $meta = new ArgumentMetadata(
            ...
            false,
            null,
            false, [new RequestBody()]
        );

        $this->assertTrue($this->createResolver()->supports(new Request(), $meta));
    }

    public function testSupportsReturnFalse(): void
    {
        $meta = new ArgumentMetadata(
            'some',
            null,
    ...
    public function testResolveThrowsWhenDeserialize(): void
    {
        ...
        // т.к. метод resolve возвращает генератор, надо начать итерировать метод.
